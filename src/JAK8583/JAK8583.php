...
class JAK8583
{
	...
	private $DATA_ELEMENT = array (
		...
		2   => array('an',  21,  self::VARIABLE_LENGTH),        //Primary account number (PAN
		...
		126 => array('ans', 999, self::VARIABLE_LENGTH),        //Issuer trace id
		127 => array('ans', 999999, self::VARIABLE_LENGTH),        //Reserved for private use
